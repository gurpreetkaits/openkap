...
class BulkDeleteVideosRequest extends FormRequest
{
    ...
    {
        return [
            'video_ids.required' => 'Please select at least one video to delete.',
            'video_ids.array' => 'Invalid video selection.',
            'video_ids.min' => 'Please select at least one video to delete.',
