...
class ApplyVideoEditsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'style_settings.camera_border_blur' => 'nullable|integer|min:0|max:20',
            'style_settings.camera_shadow' => 'nullable|integer|min:0|max:60',
            'style_settings.camera_drag_x' => 'nullable|numeric|min:0|max:100',
            'style_settings.camera_drag_y' => 'nullable|numeric|min:0|max:100',
            'style_settings.zoom_keyframes' => 'nullable|array|max:20',
            'style_settings.zoom_keyframes.*.time' => 'required|numeric|min:0',
            'style_settings.zoom_keyframes.*.duration' => 'required|numeric|min:0.1|max:60',
            'style_settings.zoom_keyframes.*.scale' => 'required|numeric|min:1|max:5',
            'style_settings.zoom_keyframes.*.x' => 'required|numeric|min:0|max:100',
            'style_settings.zoom_keyframes.*.y' => 'required|numeric|min:0|max:100',
