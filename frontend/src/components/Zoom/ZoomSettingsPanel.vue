  ...
  <div class="bg-white border-2 border-gray-200 rounded-xl p-6 transition-all" :class="{ 'border-orange-500 bg-orange-50': zoomEnabled }">
    <div class="flex items-center justify-between mb-4">
      ...
      <button
        @click="toggleZoom"
        :class="[
          'relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-orange-500 focus:ring-offset-2',
