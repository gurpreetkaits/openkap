<template>
  <div class="animate-fade-in">
    ...
    <div v-if="loading" class="grid grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 animate-pulse">
    ...
    <!-- Videos Grid View -->
    <div v-else-if="activeTab !== 'screenshots' && filteredVideos.length > 0 && viewMode === 'grid'" :key="activeTab + '-grid'" class="grid grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 animate-fade-in">
      <div
    ...
    <template v-if="activeTab === 'screenshots'">
      ...
      <!-- Screenshots Grid -->
      <div v-else-if="screenshots.length > 0" class="grid grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5">
        <div
