    ...
    <template v-else>
      ...
      <nav class="h-14 border-b border-gray-200/60 bg-white/80 backdrop-blur-md flex items-center justify-between px-4 lg:px-6 z-50 fixed top-0 w-full">
        <div class="flex items-center gap-3">
          <button @click="goBack" class="bg-orange-600 text-white w-8 h-8 rounded-lg flex items-center justify-center shadow-lg shadow-orange-500/20 hover:bg-orange-700 transition-colors">
