  ...
  <div class="min-h-screen bg-[#fafaf9] flex">
      ...
      <div class="relative z-10 space-y-8">
        ...
        <div class="space-y-3">
          <div v-for="feat in features" :key="feat" class="flex items-center gap-3">
            <div class="w-5 h-5 rounded-full bg-orange-500/10 border border-orange-500/20 flex items-center justify-center shrink-0">
    ...
    <div class="flex-1 flex flex-col items-center justify-center px-6 py-12">
      ...
      <div class="lg:hidden mb-8 text-center">
        <img src="/logo.png" alt="OpenKap" class="w-12 h-12 rounded-2xl shadow-sm mx-auto mb-3" />
      ...
      <div class="w-full max-w-sm">
        ...
        <button
          ...
          :disabled="loading"
          class="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-white border border-stone-200 rounded-xl text-sm font-medium text-stone-700 shadow-xs hover:border-stone-300 hover:shadow-sm transition-all focus:outline-hidden focus:ring-2 focus:ring-orange-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
