    ...
    public function run(): void
    {
        $blogs = [
            [
                ...
                'meta_title' => 'Free Screen Recording Guide 2025 | OpenKap',
                'meta_description' => 'Discover how to record your screen for free with OpenKap. No watermarks, no time limits. Perfect for creating tutorials and demos.',
                'read_time' => 5,
                'is_published' => true,
                'published_at' => now()->subDays(7),
            ],
            [
                'title' => 'OpenKap vs Loom: The Affordable Alternative That Gets the Job Done',
                'slug' => 'openkap-vs-loom-affordable-alternative',
                'excerpt' => 'Tired of expensive screen recording subscriptions? See how OpenKap offers the same features as Loom at a fraction of the cost.',
                'content' => $this->getLoomAlternativeContent(),
                'author' => 'OpenKap Team',
                'category' => 'Comparisons',
                'tags' => ['loom alternative', 'affordable', 'comparison', 'pricing', 'screen recording'],
                'meta_title' => 'OpenKap vs Loom: Affordable Screen Recording Alternative',
                'meta_description' => 'Compare OpenKap and Loom. Get the same screen recording features at 80% lower cost. No compromises on quality.',
                'read_time' => 4,
                'is_published' => true,
            ...
            [
                ...
                'meta_title' => 'Simple Screen Recording Tools: Why Less is More | OpenKap',
                'meta_description' => 'Learn why simple screen recording tools outperform bloated alternatives. OpenKap focuses on what matters: easy, fast, reliable screen capture.',
                'read_time' => 3,
                'is_published' => true,
                'published_at' => now(),
            ],
...
<article class="blog-content">
    ...
    <p>Some free tools limit you to 5-minute recordings. That's barely enough for a quick demo. OpenKap offers generous recording limits even on the free tier.</p>
    ...
    <h2>Getting Started with OpenKap</h2>
    <p>OpenKap makes screen recording dead simple:</p>
    <ol>
    ...
    <p>Don't let expensive software hold you back. With OpenKap, you can start creating professional screen recordings in seconds - completely free. No downloads, no watermarks, no hassle.</p>
...
HTML;
    ...
    private function getLoomAlternativeContent(): string
    {
        return <<<'HTML'
<article class="blog-content">
    <p class="lead">Loom revolutionized async video communication, but at $15/month per user, it's not exactly budget-friendly. Enter OpenKap: all the features you need at a price that makes sense.</p>
    ...
    <ul>
        ...
        <li>OpenKap Pro: $7/month per user ($840/year)</li>
    ...
    <h2>What OpenKap Does Differently</h2>

    <h3>1. Focused Simplicity</h3>
    <p>We don't try to be everything. OpenKap does one thing exceptionally well: screen recording. No bloated features you'll never use.</p>
    ...
    <ol>
        <li>Sign up for OpenKap (takes 30 seconds)</li>
        <li>Start recording immediately</li>
        <li>Share your new videos with the same ease</li>
    </ol>

    <h2>The Bottom Line</h2>
    <p>Loom is a great product, but you're paying a premium for the brand name. OpenKap delivers the same core functionality at a fraction of the cost. For most users, that's a no-brainer.</p>

    <p><strong>Try OpenKap free today</strong> and see the difference for yourself.</p>
</article>
HTML;
    }
    ...
    private function getMvpContent(): string
    {
        return <<<'HTML'
<article class="blog-content">
    <p class="lead">In the age of feature bloat, there's something refreshing about software that just works. OpenKap is built on a simple philosophy: do one thing, do it well, and get out of your way.</p>
    ...
    <h3>Speed</h3>
    <p>OpenKap loads instantly. No waiting for bloated JavaScript bundles or unnecessary animations. Click, record, done.</p>

    <h3>Reliability</h3>
    <p>Fewer features mean fewer things that can break. Our simple architecture means your recordings work, every time.</p>

    <h3>Ease of Use</h3>
    <p>No tutorials needed. No certification courses. If you can click a button, you can use OpenKap.</p>
    ...
    <h2>Try Simple</h2>
    <p>If you're tired of software that tries to do everything and does nothing well, give OpenKap a try. Experience what screen recording feels like when it's designed around your workflow, not around a feature checklist.</p>
