...
<body class="bg-brand-950 text-neutral-300 antialiased selection:bg-brand-500/30 selection:text-brand-100 flex flex-col min-h-screen">
    ...
    <!-- Main Content -->
    <main class="relative flex-grow pt-24">
        ...
        <!-- Hero Section -->
        <div class="max-w-5xl mx-auto px-6 flex flex-col items-center text-center relative z-10 py-20">
            ...
            <div class="mt-20 w-full max-w-4xl border border-white/10 rounded-2xl bg-[#0F0F0F] shadow-2xl overflow-hidden relative group">
                ...
                <div class="aspect-video bg-neutral-900/50 relative">
                    <video id="demoVideo" class="w-full h-full object-contain" playsinline preload="metadata">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-8 h-[500px] bg-[#0A0A0A] border border-white/10 rounded-2xl shadow-2xl relative overflow-hidden">
                    ...
                    <div id="tab-capture" class="absolute inset-0 pt-12 flex items-center justify-center transition-all duration-500">
                        <img src="/demo/how-to-record-screen.gif" alt="How to record screen" class="w-full h-full object-contain">
                    </div>
                    ...
                    <div id="tab-share" class="absolute inset-0 pt-12 flex items-center justify-center transition-all duration-500 opacity-0 pointer-events-none translate-y-4">
                        <img src="/demo/copy-share-link.gif" alt="Copy and share link" class="w-full h-full object-contain">
                    </div>
    ...
    <!-- Footer -->
    <footer class="border-t border-white/10 bg-neutral-950 py-12 mt-auto">
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="flex items-center gap-3">
                <img src="/logo.png" alt="ScreenSense" class="size-5 rounded">
                <span class="text-xs font-medium text-neutral-500">&copy; {{ date('Y') }} ScreenSense</span>
            </div>
            <div class="flex gap-6 text-xs text-neutral-500 font-medium">
    ...
    <script>
        ...
        fetch('https://api.github.com/repos/gurpreetkaits/screensense')
            ...
            .then(data => {
                ...
                document.getElementById('github-stars-nav').textContent = stars;
            })
            .catch(() => {
                document.getElementById('github-stars').textContent = '0';
                document.getElementById('github-stars-nav').textContent = '0';
            });
